# -*- coding: utf-8 -*-
"""
Created on Wed Apr  7 14:57:33 2021
...
dim=(DIGIT_WIDTH, DIGIT_HEIGHT)
# =============================================================================
# def load_digits(fn):
#     print('loading "%s for training" ...' % fn)
#     digits_img = cv2.imread(fn, 0)
#     digits = split2d(digits_img,dim)
#     resized_digits = []
#     for digit in digits:
#         resize_digit=cv2.resize(digit,dim, interpolation = cv2.INTER_CUBIC)
#         resized_digits.append(resize_digit)
...
def get_contour_precedence(contour, cols):
    return contour[1] * cols + contour[0]  #row-wise or
...
TEST_USER_IMG = 'Cropped_Contour.png'
